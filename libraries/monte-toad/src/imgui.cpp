...
bool ImGui::InputInt(const char * label, size_t * value, int step) {
...
bool ImGui::InputInt(const char * label, uint16_t * value, int step) {
  int valueAsInt = static_cast<int>(*value);
  bool result = ImGui::InputInt(label, &valueAsInt, step);
...
bool ImGui::InputInt2(const char * label, uint16_t * value, int step) {
